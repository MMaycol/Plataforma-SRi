...
export const registerUser = async (req, res) => {
  try {
    const { Nombres, Apellidos, LoginUsuario, LoginClave } = req.body;
    ...
    await pool.request()
      ...
      .query('INSERT INTO USUARIO (Nombres, Apellidos, LoginUsuario, LoginClave) VALUES (@Nombres, @Apellidos, @LoginUsuario, @LoginClave)');
...
export const Login = async (req, res) => {
  try {
    ...
    try {
      ...
      return res.status(200).send({ status: "Éxito", message: "Conexión exitosa" });
